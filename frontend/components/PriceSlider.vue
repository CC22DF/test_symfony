<template>
    ...
    <div class="track-container">
        ...
        <button class="track-btn track1" ref="track1"> <span class="range-value min">{{ minValue }}€ </span></button>
        <button class="track-btn track2" ref="track2"><span class="range-value max">{{ maxValue }}€</span></button>
    </div>
</template>
